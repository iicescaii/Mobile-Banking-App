        ...
        <View style={styles.section}>
          <View style={styles.checkboxContainer}>
            ...
            <Text style={styles.checkboxText}>
              I hereby ratify and confirm the enrollment of my co-depositor/s in ZenBank Online Banking and irrevocably consent and agree that all Zenbank Online Banking transactions made or caused to be made by any of my co-depositor/s on our enrolled Joint OR account is valid and binding upon me. I absolutely waive any and all rights, interests, claims and cause/s of action against ZenBank arising from or in connection herewith.I hereby understand that this consent and undertaking is applicable for Joint OR Accounts only.By ticking this box, I confirm that I have read, understood, and agree to the foregoing and comply with the terms and conditions of ZenBank
            </Text>
          </View>
        </View>
