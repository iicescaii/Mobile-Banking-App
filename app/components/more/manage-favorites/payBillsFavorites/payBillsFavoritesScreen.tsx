  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      try {
        ...
        const res = await axios.get<FavoriteBiller[]>('http://192.168.1.7:5000/api/favorite-billers', {
  ...
  const handleFavoritePress = (fav: FavoriteBiller) => {
    router.push({
      ...
      params: {
          ...
          subscriber_account_number: fav.subscriber_account_number,
          subscriber_account_name: fav.subscriber_account_name,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity  style={styles.addButton} onPress={() => router.push('/components/more/manage-favorites/payBillsFavorites/biller-list')}>
