...
const SuccessOwnScreen: React.FC = () => {
  const {
    amount,
    from,
    from_account,
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      {/* Close icon */}
      <TouchableOpacity onPress={() => router.replace('/sendmoney/ownacc')} style={styles.closeBtn}>
      ...
      <ViewShot ref={cardRef} options={{ format: 'png', quality: 1 }} style={styles.card}>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.rightAlign}>
            <Text style={styles.boldValue}>My Checking Account</Text>
...
export default SuccessOwnScreen;
